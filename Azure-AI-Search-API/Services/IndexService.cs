...
namespace Azure_AI_Search_API.Services
{
    public class IndexService : IIndexService
    {
        ...
        private static GolfBallHelper? _ballHelper;
        private static readonly object _ballHelperLock = new object();

        public IndexService(IConfiguration configuration, ILogger<AISearchHelper>? logger = null)
        {
        ...
        public async Task CreateTextIndexAsync(string indexName, SearchIndexClient indexClient)
        {
        ...
        public async Task CreateTextImageIndexAsync(string indexName, SearchIndexClient indexClient)
        {
            const string vectorSearchHnswConfig = "golfHnsw";
        ...
        public async Task<List<SearchDocument>> ListDocumentsAsync(string indexName, SearchIndexClient indexClient, bool suppressVectorFields = true, int maxResults = 1000)
        {
            try
            {
        ...
        public async Task GenerateTextEmbeddingsAsync(AzureOpenAIClient azureOpenAIClient, SearchClient searchClient)
        {
        ...
        public async Task GenerateTextImageEmbeddingsAsync(AzureOpenAIClient azureOpenAIClient, SearchClient searchClient)
        {
            // Generates embeddings and adds the document by ingesting the data in the CSV file.
        ...
        public async Task<List<GolfBallDataV2>> SearchTextImageOnly(
           SearchClient searchClient,
        ...
        #region GolfBall Helper Operations
        public async Task<float[]> GenerateImageEmbeddingsAsyncV3(byte[] imageBytes)
        {
            return await _ballHelper!.GenerateImageEmbeddingAsyncV3(imageBytes);
        }

        public async Task UploadGolfBallDataTextOnlyAsync(AzureOpenAIClient azureOpenAIClient, SearchClient searchClient)
        {
            await _ballHelper!.UploadGolfBallDataTextOnlyAsync(azureOpenAIClient, searchClient);
        }
        public async Task UploadGolfBallDataTextImageAsyncV2(AzureOpenAIClient azureOpenAIClient, SearchClient searchClient)
        {
            await _ballHelper!.UploadGolfBallDataTextImageAsyncV2(azureOpenAIClient, searchClient);
        }
        #endregion
